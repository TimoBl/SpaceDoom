...
function draw_borders(canvas, state, dx, dy) {
		canvas.lineWidth = 3
		...
		canvas.moveTo(zone.x0 + dx, zone.y0 + dy);
		canvas.lineTo(zone.x1 + dx, zone.y0 + dy);
		canvas.lineTo(zone.x1 + dx, zone.y1 + dy);
		canvas.lineTo(zone.x0 + dx, zone.y1 + dy);
		canvas.lineTo(zone.x0 + dx, zone.y0 + dy);
		canvas.stroke();
}
